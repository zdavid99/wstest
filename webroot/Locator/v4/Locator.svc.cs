...
using com.ocwebservice.locator.service;
...
namespace com.ocwebservice
{
    ...
    public class LocatorV4 : ILocator
    {
        ...
        {
            IEnumerable<ILocatorResult> results = LocatorService.Instance.GetDealerLocatorResultsV4(searchOptions);
